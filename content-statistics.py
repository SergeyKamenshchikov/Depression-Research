...
def distribution(z,k):#z - list,k - label
    ...
    plt.hist(z,rwidth=1.5,bins=100,range=(10,60))
    plt.xlabel(k);
    plt.ylabel('Число')
    plt.show()
#/PDF function    
...
distribution(sent_len,'длина предложения')
#/Sentence length distribution#
...
for words, count in ngramsFreqs.most_common(m):#words or count
...
print('\nЧисло иррациональных сообщений: '+str(hn))
print('Число сообщений: '+str(mn))
print('Число иррациональностей: '+str(rsn))
