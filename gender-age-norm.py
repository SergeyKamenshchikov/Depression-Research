...
#object for morphologic analysis#
...
#read urls-gender-age into the lists#
file_path=(absolute_path+'/txt/age-gender-length-url.txt');#create absolute path to age-url dictionary
